          ...
          <div className="mt-2 pt-2 border-t border-black/10 flex items-center justify-between text-slate-600 relative shrink-0">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                title="이 메모 삭제"
                className="flex items-center gap-1 px-2.5 py-1 rounded-md bg-rose-500/10 hover:bg-rose-600 text-rose-600 hover:text-white font-bold text-xs transition-all shadow-xs active:scale-95 border border-rose-200 hover:border-rose-600"
              >
